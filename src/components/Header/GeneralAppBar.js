          ...
          <div class="w-full justify-between flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <a
                  class="text-gray-600  hover:text-blue-400 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  href="/#"
                >
                  Personal Backup
                </a>
                <a
                  class="text-gray-600 dark:text-white  hover:text-blue-400 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  href="/#"
                >
                  Business Backup
                </a>
