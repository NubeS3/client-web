  ...
  return (
    <div className="flex flex-col mx-auto justify-center max-w-2xl px-4 bg-white shadow rounded-sm my-auto text-gray-600">
      ...
      <div className="mt-6 mb-6 px-4">
        <p>
          A bucket is a container that holds files that are uploaded into NubeS3
          Cloud Storage. The bucket name must be unique globally and must have a
          ...
          <div className="grid grid-cols-3">
            ...
            <div className="col-span-3 mb-4">
              ...
              <form>
                ...
                <br />
                <input type="radio" id="b-public" name="type" value="public" />
